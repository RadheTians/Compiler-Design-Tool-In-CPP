...
char read[15][10],gl[15],temp,templ[15],tempr[15][10],*ptr,temp2[5],dfa[15][15];
string gr[15];
...
int  main()
{
    ...
    for(int z=0;z<n;z++){
        gl[z]=production[z][0];
        gr[z]=production[z].substr(2,production[z].length());
    }
